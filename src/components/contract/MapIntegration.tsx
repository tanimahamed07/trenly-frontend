...
const MapIntegration = () => {
   ...
   */
  const googleMapsEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.1963286367373!2d90.37086887589366!3d23.740417989163276!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b2969408e3%3A0x629555c825447153!2sDhanmondi%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1710000000000!5m2!1sen!2sbd";
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex justify-between items-end mb-14">
          <div className="space-y-3">
            ...
            <p className="text-neutral/40 font-medium text-sm">Find us in the heart of the city</p>
          </div>
          ...
          >
            Get Directions
            <ExternalLink size={15} className="group-hover:scale-110 transition-transform duration-300" />
          </a>
        </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="group relative overflow-hidden p-8 rounded-[2rem] md:rounded-[2.5rem] bg-base-200 border border-base-300 transition-all duration-500 hover:-translate-y-1 flex-grow">
              ...
              <div className="relative z-10 space-y-4">
                <div>
                  <h3 className="text-xl font-black text-secondary leading-tight">Dhanmondi HQ</h3>
                  <p className="text-xs font-bold opacity-35 uppercase tracking-widest mt-1">Headquarters</p>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="pt-4 border-t border-base-300">
                    <p className="text-[10px] font-black uppercase tracking-widest text-primary mb-1">Store Hours</p>
                    <p className="text-sm font-bold text-secondary">Sat - Thu: 9AM - 8PM</p>
                  </div>
                </div>
              </div>
